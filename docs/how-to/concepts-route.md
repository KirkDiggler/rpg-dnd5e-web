...
| `dungeon-builder/` | Design review (web#666)  | S4 board for rpg-project#170/#169 — palette/board/YAML panes, live `PutDungeon(validate_only)` with a FIXTURES MODE fallback, hex-true/flattened layout toggle; see its `CONTRACT.md`. |
