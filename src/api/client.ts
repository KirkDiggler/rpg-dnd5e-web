...
// assembly, GameView slice 2). Distinct from v1alpha1 EncounterService's
// old CreateEncounter/JoinEncounter/SetReady lobby RPCs, deleted in slice 3
// along with LobbyView, their only caller.
